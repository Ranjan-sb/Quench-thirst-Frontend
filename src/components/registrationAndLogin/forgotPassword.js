        ...
        <Formik
            ...
            onSubmit={async (values) => {
                try {
                    ...
                    const response = await axios.put('http://localhost:3100/api/users/forgotPassword', formData)
                        ...
                        <Col xs={12} md={6} className='m-auto'>
                            <Card className='m-auto p-3' border="primary">
                                <Card.Body>
                                    ...
                                    {
                                        Object.keys(serverErrors).length > 0 && <div className="error-message">
                                            **{serverErrors.error}
                                        </div>
                                    }
                                    <Form>
                                        ...
                                        {
                                            Object.keys(formErrors).length > 0 && <div className="error-message">{formErrors.email}</div>
                                        }
                                        ...
                                        <ErrorMessage className="error-message" component="div" name="otp" /> <br />

                                        <label className="form-label" htmlFor="password">password</label>
                                        <Field className="form-control" name="password" type="text" disabled={isActive} id="password" />
                                        <ErrorMessage className="error-message" component="div" name="password" /> <br />
